...
type TasksClient interface {
	...
	Add(ctx context.Context, in *NewTask, opts ...grpc.CallOption) (*Task, error)
}
...
func (c *tasksClient) List(ctx context.Context, in *Void, opts ...grpc.CallOption) (*TaskList, error) {
	out := new(TaskList)
	err := c.cc.Invoke(ctx, "/list.Tasks/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tasksClient) Add(ctx context.Context, in *NewTask, opts ...grpc.CallOption) (*Task, error) {
	out := new(Task)
	err := c.cc.Invoke(ctx, "/list.Tasks/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TasksServer interface {
	...
	Add(context.Context, *NewTask) (*Task, error)
...
func (UnimplementedTasksServer) Add(context.Context, *NewTask) (*Task, error) {
...
func _Tasks_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/list.Tasks/Add",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TasksServer).Add(ctx, req.(*NewTask))
	}
	return interceptor(ctx, in, info, handler)
}
